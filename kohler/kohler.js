// ==========================================================================
// kohler.js — page-only behavior for the hidden Kohler page.
// Handles: smooth scroll to Questions, the JD accordion, and the notes
// fields (auto-grow, localStorage persistence).
// ==========================================================================
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // JD accordion
  // ------------------------------------------------------------------
  var triggers = document.querySelectorAll(".kh-acc-trigger");

  function openPanel(trigger) {
    var panel = document.getElementById(trigger.getAttribute("aria-controls"));
    if (!panel) return;
    var item = trigger.closest(".kh-acc-item");
  ...
  // markers.
  // ------------------------------------------------------------------
  var STORAGE_PREFIX = "kohlerNotes:";
  ...
  function updateHasNotesMarker(qid, value) {
    var card = document.querySelector('.kh-q-card[data-card="' + qid + '"]');
    if (!card) return;
  ...
  function showSavedIndicator(qid) {
    var card = document.querySelector('.kh-q-card[data-card="' + qid + '"]');
    if (!card) return;
    var indicator = card.querySelector(".kh-note-saved");
    if (!indicator) return;
  ...
  var noteInputs = document.querySelectorAll(".kh-note-input");
